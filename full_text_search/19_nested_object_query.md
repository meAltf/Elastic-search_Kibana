...
# search by actor's dob and country
POST /movies/_search
{
  "query": {
    "nested": {
...
# inner hits - to understand the child object score - when you have 1000 childobjects, we might not know what matched. so this inner hits will be helpful
POST /movies/_search
{
  "query": {
    "nested": {
