# pagination search results | demo"
...
/*
    size - 10 (LIMIT)
    from - 0 (OFFSET)
    More: https://www.elastic.co/guide/en/elasticsearch/reference/current/paginate-search-results.html
*/
...
# size = 2
# from is number of records to skip
# from = (page - 1) * size
POST /movies/_search
{
  "query": {
...
# pagination - next page with 2 records
# from - no of records to skip
# from = (page - 1) * size
POST /movies/_search
{
  "query": {
